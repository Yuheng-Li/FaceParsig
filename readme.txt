...
WARNING: label order is different!!! The result annotation (https://github.com/zllrunning/face-parsing.PyTorch/issues/12) is not same as CelebaHQ dataset annotation (https://github.com/switchablenorms/CelebAMask-HQ/tree/master/face_parsing)
